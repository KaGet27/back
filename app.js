...
//Gestion du CORS = Cross Origin Resource Sharing quand back et front n'on pas la même origine
...
app.post('/api/stuff', (req, res, next) => {
    ...
    const thing = new Thing({
        // ... permet de mapper les objets du form client directement dans notre model
       ...req.body
    });
